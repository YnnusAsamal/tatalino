...
<div class="container-fluid p-0">
  ...
  <main class="container">
      ...
      <div class="row">
          <div class="col mb-3">
            <div class="card" onclick="window.location='{{ route('collections.show', $category->id) }}'">
              <div class="card-body">
                  <h5 class="card-title">{{ $category->name }} - {{ $category->subcategory }}</h5>
                  <p class="card-text">{{ $category->posts_count }} {{ Str::plural('Post', $category->posts_count) }}</p>
                  <span class="read-more">Read More</span>
              </div>
            </div>
              <!-- <div class="card p-3" onclick="window.location='{{ route('collections.show', $category->id) }}'">
                  <h5 class="card-title">{{ $category->name }} - {{ $category->subcategory }}</h5>
                  <p class="card-text">{{ $category->posts_count }} {{ Str::plural('Post', $category->posts_count) }}</p>
                  <span class="read-more">Read More</span>
              </div> -->
