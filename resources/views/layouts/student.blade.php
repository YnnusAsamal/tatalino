...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top py-3">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold fs-4" href="{{ url('/') }}">
                <img src="{{asset('public/assets/logo_1.png')}}" alt="" srcset="" width="75px" height="100px" class="d-inline-block align-text-top">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-3">
                    ...
                    @auth
                        ...
                        <li class="nav-item">
                            <a class="nav-link fw-semibold" href="{{ route('studentposts.create') }}">
                                Submit your Work
                            </a>
                        </li>
    ...
    <div class="content" style="position: relative; z-index: 1;">
        ...
        <header class="animated-header">
            <h1 class="logo">
                <img src="{{ asset('public/assets/words.png') }}" alt="" width="350px">
            </h1>
