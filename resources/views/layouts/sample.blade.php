        ...
        <div class="sidebar border-right sticky-top" id="sidebar-wrapper">
            <div class="sidebar-heading text-white"><img src="{{asset('public/assets/logo.JPG')}}" width="75px"> TINTATALINO</div>
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('authors.index')}}" class="dropdown-item text-whit mb-2"><span class="bi bi-speedometer"></span>&nbspManage Authors</a>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                ...
                                <div class="accordion-body">
                                    <a class="dropdown-item text-white" href="{{ route('roles.index')}}"><span class="bi bi-person"> Manage Roles</span></a>
                                    <a class="dropdown-item text-white" href="{{ route('permissions.index')}}"><span class="bi bi-shield-lock"> Manage Permissions</span></a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-white" href="{{ route('users.index')}}"><span class="bi bi-people"> Manage Users</span></a>
