    ...
    <div id="main-wrapper" class="container">
        ...
        <div class="row justify-content-center mb-3">
            ...
            <div class="col-xl-10">
                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <br>
                                    <img src="{{ asset('public/assets/words.png') }}" alt="Welcome Image" class="img-fluid mb-3 text-center" style="max-width: 200px;">
                                    <br>
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="{{ old('email') }}" required autofocus>
                                        </div>
                                        ...
                                        <a href="{{ route('password.request') }}" class="forgot-link float-right text-primary">Forgot password?</a>
                                        @endif
                                    </form>
                                </div>
                            </div>
                ...
                <p class="text-muted text-center mt-3 mb-0">Don't have an account? <a href="{{ route('register') }}" class="forgot-link ml-1">register</a></p>
