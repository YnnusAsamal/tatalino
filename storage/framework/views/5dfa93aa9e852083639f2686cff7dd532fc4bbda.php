...
<div class="row mb-4">
    <div class="col-md-6">
        <form action="<?php echo e(route('authors.index')); ?>" method="GET">
            <div class="input-group">
                <input type="text" name="search" class="form-control" placeholder="Search authors..." value="<?php echo e(request('search')); ?>">
                <button class="btn btn-outline-secondary" type="submit">Search</button>
                <a href="<?php echo e(route('authors.index')); ?>" class="btn btn-outline-info">Refresh</a>
            </div>
        </form>
    </div>
</div>
                ...
                <div class="member-card pt-2 pb-2">
                    ...
                    ?>
                        <?php if($firstImage): ?>
                            ...
                            <div class="thumb-lg member-thumb mx-auto"><img src="h<?php echo e(asset('assets/userprofiles/' . $firstImage)); ?>" class="rounded-circle img-thumbnail" alt="profile-image"></div>
                        <?php else: ?>
                    ...
                    <div class="">
                        ...
                        <p class="text-muted"><?php echo e($author->profile->bio); ?></p>
                    </div>
                    ...
                    <div class="text-center mt-2 mb-2">
                        <form action="<?php echo e(route('authors.featured', $author->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.sample', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tatalino\resources\views/authors/index.blade.php ENDPATH**/ ?>