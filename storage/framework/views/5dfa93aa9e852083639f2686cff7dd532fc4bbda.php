        ...
        <div class="col-lg-4">
            <div class="text-center card-box">
                <div class="member-card pt-2 pb-2">
                    ...
                    ?>
                        <?php if($firstImage): ?>
                            <div class="thumb-lg member-thumb mx-auto"><img src="<?php echo e(asset('assets/userprofiles/' . $firstImage)); ?>" class="rounded-circle img-thumbnail" alt="profile-image"></div>
                        <?php else: ?>
