...
<div class="min-h-screen dark:bg-slate-800 gap-6 flex items-center justify-center">
    <div
        ...
        ?>
        <?php if($firstImage): ?>
            <img src="<?php echo e(asset('public/assets/userprofiles/' . $firstImage)); ?>" alt="Profile Image"  class="w-32 group-hover:w-36 group-hover:h-36 h-32 object-center object-cover rounded-full transition-all duration-500 delay-500 transform">
        <?php else: ?>
            <p>No profile image available.</p>
        <?php endif; ?>
        <div class="w-fit transition-all transform duration-500">
            <h1 class="text-gray-600 dark:text-gray-200 font-bold">
                <h2><?php echo e($author->name); ?><small><?php echo e($author->profile->bio); ?></small></h2>
            </h1>
            ...
            <strong><?php echo e($author->profile->user_description); ?></strong>
            </a>
        </div>
        </div>
