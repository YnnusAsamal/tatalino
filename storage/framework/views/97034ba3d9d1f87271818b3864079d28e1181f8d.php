...
<div class="container-fluid p-0">
  <div class="container">
    <div class="row">
      <div class="col">
        <h3 class="float-start">Category: <?php echo e($category->name); ?></h3>
        <a href="<?php echo e(route('collections.index')); ?>" class="btn btn-outline-secondary btn-sm float-end">Back to Collections</a>
      </div>
    </div>
    ...
    <div class="row mt-3">
        ...
        <div class="col mb-3">
            ...
            <!-- <div class="card p-3">
                ...
                <p><?php echo e(Str::limit($post->body, 100)); ?></p>
                <a href="<?php echo e(route('studentposts.show', $post->id)); ?>" class="btn btn-sm btn-primary">Read More</a>
            </div> -->
        </div>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\tatalino\resources\views/collections/show.blade.php ENDPATH**/ ?>