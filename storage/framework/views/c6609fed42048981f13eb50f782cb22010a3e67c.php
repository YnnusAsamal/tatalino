...
<div class="card shadow">
    <div class="card-body">
        <div class="input-group dontPrint">
            <form method="GET" action="<?php echo e(route('monthly.report')); ?>" class="d-flex">
        ...
        <div>
            <h3>Top Selling Month: <?php echo e($topMonthName); ?></h3>
            <p>Total Sales: <?php echo e($topMonth); ?></p>
        </div>
        ...
        <div>
            <h3>Total Consumption for <?php echo e($selectedYear); ?></h3>
            <p><?php echo e($totalConsumptionYearly); ?></p>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\waterbilling\resources\views/consumptions/monthly_report.blade.php ENDPATH**/ ?>